...
const Foot = React.createClass({
  ...
  setPd(e, json = this.props.s.state) {
    json.foot.foot.pd = parseInt(e.target.value);
    this.props.s.setState(json);
  },
  setIced(e, json = this.props.s.state) {
...
const Info = React.createClass({
  ...
  render(s = this.props.s.state){
    const sum = {
      ...
      dml: Math.round(Math.round((100 - s.moreless.gmp) / 100 * (100 - s.moreless.lmp) / 100 * (100 - s.moreless.fork) / 100 * (100 + s.moreless.pjtdm )) / 100 * Math.round((100 + s.moreless.tr) / 100 * (100 + s.moreless.trd)) / 100 * Math.round((100 - s.moreless.mtr) / 100 * (100 - s.moreless.ci) * (1 + 0.04 * s.player.gb)) / 100 *  (100 + s.moreless.rg)) / 100,
      hdml: Math.round(Math.round((100 - s.moreless.gmp) / 100 * (100 - s.moreless.lmp) / 100 * (100 - s.moreless.fork) / 100 * (100 + s.moreless.pjtdm )) / 100 * (100 + s.weaponadd.pm) / 100 * Math.round((100 + s.moreless.tr) / 100 * (100 + s.moreless.trd)) / 100 * Math.round((100 - s.moreless.mtr) / 100 * (100 - s.moreless.ci) /100 * (1 + 0.04 * s.player.gb) * (100 + s.hideinfo.hy) / 100 * (100 + s.hideinfo.pb)) / 100  * (100 + s.moreless.rg)) / 100,
    };
    ...
    const hidebasic = {
      ...
      pus: ((weapon.ps + sum.ps) * (100 + sum.pjtd + sum.pd + sum.cud + sum.cupd) / 100 * sum.pdml * Math.round(sum.hdml * Math.floor(s.skill.bd)) / 100 * (100 - s.skill.pti - s.skill.ptt - s.skill.ptf - s.skill.ptz) / 100),
      pub: ((weapon.pb + sum.pb) * (100 + sum.pjtd + sum.pd + sum.cud + sum.cupd) / 100 * sum.pdml * Math.round(sum.hdml * Math.floor(s.skill.bd)) / 100 * (100 - s.skill.pti - s.skill.ptt - s.skill.ptf - s.skill.ptz) / 100),
    };
    const calc = {
