...
const Info = React.createClass({
  ...
  render(s = this.props.s.state){
    const sum = {
      ...
      edml: ml(s.moreless.wedm, s.moreless.edm),  
    ...
    const basic = {
      ...
      ices: Math.round((el(sum.ices, sum.iced) + (weapon.ps + sum.ps) * (100 + sum.wed + sum.ed + sum.iced + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (Math.floor(s.aural.hate * (100 + s.talent.aura) / 100)  + s.skill.pti + s.skill.ptiadd) / 100 ) * (100 - s.skill.itf) / 100),
      iceb: Math.round((el(sum.iceb, sum.iced) + (weapon.pb + sum.pb) * (100 + sum.wed + sum.ed + sum.iced + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (Math.floor(s.aural.hate * (100 + s.talent.aura) / 100)  + s.skill.pti + s.skill.ptiadd) / 100 ) * (100 - s.skill.itf) / 100),
      fs: Math.round((el(sum.fs, sum.fd) + (sum.ices * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd) / 100 * sum.edml * Math.round(sum.dml * s.skill.bd) / 100 + (weapon.ps + sum.ps) * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (Math.floor(s.aural.hate * (100 + s.talent.aura) / 100)  + s.skill.pti + s.skill.ptiadd) / 100) * (s.skill.itf + s.skill.itfadd) / 100 + (weapon.ps + sum.ps) * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * Math.round(s.skill.ptfadd + s.skill.ptf) / 100) * (100 - s.skill.ftz) / 100),
      fb: Math.round((el(sum.fb, sum.fd) + (sum.iceb * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd) / 100 * sum.edml * Math.round(sum.dml * s.skill.bd) / 100 + (weapon.pb + sum.pb) * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (Math.floor(s.aural.hate * (100 + s.talent.aura) / 100)  + s.skill.pti + s.skill.ptiadd) / 100) * (s.skill.itf + s.skill.itfadd) / 100 + (weapon.pb + sum.pb) * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * Math.round(s.skill.ptfadd + s.skill.ptf) / 100) * (100 - s.skill.ftz) / 100),
      ts: Math.round((el(sum.ts, sum.td) + (weapon.ps + sum.ps) * (100 + sum.wed + sum.ed + sum.td + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (s.skill.pttadd + s.skill.ptt) / 100) * (100 - s.weaponadd.ttz) / 100),
      tb: Math.round((el(sum.tb, sum.td) + (weapon.pb + sum.pb) * (100 + sum.wed + sum.ed + sum.td + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (s.skill.pttadd + s.skill.ptt) / 100) * (100 - s.weaponadd.ttz) / 100),
      ps: Math.round((weapon.ps + sum.ps) * (100 + sum.pjtd + sum.pd) / 100 * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (100 - s.skill.pti - s.skill.ptt - s.skill.ptf - s.skill.ptz) / 100),
      pb: Math.round((weapon.pb + sum.pb) * (100 + sum.pjtd + sum.pd) / 100 * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (100 - s.skill.pti - s.skill.ptt - s.skill.ptf - s.skill.ptz) / 100),
      zs: Math.round(sum.zs * (100 + sum.zd + sum.pjtd) / 100 * Math.round(sum.dml * s.skill.bd) / 100 + (weapon.ps + sum.ps) * (100 + sum.pjtd + sum.pd + sum.zd) / 100 * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (s.skill.ptzadd + s.skill.ptz) / 100 + (sum.ts * (100 + sum.wed + sum.ed + sum.td + sum.pjtd +sum.zd) / 100 * sum.edml * Math.round(sum.dml * s.skill.bd) / 100 + (weapon.ps + sum.ps) * (100 + sum.wed + sum.ed + sum.td + sum.pjtd + sum.pd + sum.zd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (s.skill.pttadd + s.skill.ptt) / 100) * s.weaponadd.ttz / 100 + (sum.fs * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd + sum.zd) / 100 * sum.edml * Math.round(sum.dml * s.skill.bd) / 100 + (sum.ices * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd + sum.zd) / 100 * sum.edml * Math.round(sum.dml * s.skill.bd) / 100 + (weapon.ps + sum.ps) * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd + sum.pd + sum.zd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (Math.floor(s.aural.hate * (100 + s.talent.aura) / 100)  + s.skill.pti + s.skill.ptiadd) / 100) * (s.skill.itf + s.skill.itfadd) / 100 + (weapon.ps + sum.ps) * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd + sum.pd + sum.zd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * Math.round(s.skill.ptfadd + s.skill.ptf) / 100) * s.skill.ftz / 100),
      zb: Math.round(sum.zb * (100 + sum.zd + sum.pjtd) / 100 * Math.round(sum.dml * s.skill.bd) / 100 + (weapon.pb + sum.pb) * (100 + sum.pjtd + sum.pd + sum.zd) / 100 * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (s.skill.ptzadd + s.skill.ptz) / 100 + (sum.tb * (100 + sum.wed + sum.ed + sum.td + sum.pjtd +sum.zd) / 100 * sum.edml * Math.round(sum.dml * s.skill.bd) / 100 + (weapon.pb + sum.pb) * (100 + sum.wed + sum.ed + sum.td + sum.pjtd + sum.pd + sum.zd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (s.skill.pttadd + s.skill.ptt) / 100) * s.weaponadd.ttz / 100 + (sum.fb * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd + sum.zd) / 100 * sum.edml * Math.round(sum.dml * s.skill.bd) / 100 + (sum.iceb * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd + sum.zd) / 100 * sum.edml * Math.round(sum.dml * s.skill.bd) / 100 + (weapon.pb + sum.pb) * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd + sum.pd + sum.zd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (Math.floor(s.aural.hate * (100 + s.talent.aura) / 100)  + s.skill.pti + s.skill.ptiadd) / 100) * (s.skill.itf + s.skill.itfadd) / 100 + (weapon.pb + sum.pb) * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd + sum.pd + sum.zd) / 100 * sum.edml * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * Math.round(s.skill.ptfadd + s.skill.ptf) / 100) * s.skill.ftz / 100),
      pus: ((weapon.ps + sum.ps) * (100 + sum.pjtd + sum.pd + sum.cud + sum.cupd) / 100 * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (100 - s.skill.pti - s.skill.ptt - s.skill.ptf - s.skill.ptz) / 100),
      pub: ((weapon.pb + sum.pb) * (100 + sum.pjtd + sum.pd + sum.cud + sum.cupd) / 100 * sum.pdml * Math.round(sum.dml * s.skill.bd) / 100 * (100 - s.skill.pti - s.skill.ptt - s.skill.ptf - s.skill.ptz) / 100),
    };
    ...
    const hidebasic = {
      as: this.props.s.sub(this.props.s.div(Math.round(this.props.s.div(this.props.s.mul(this.props.s.mul((this.props.s.add(100, s.weaponadd.as)), (this.props.s.add(100, sum.as))), (this.props.s.sub(100, s.skill.asl))), 10000)), 100), 1),
      ices: Math.round((sum.ices * (100 + sum.wed + sum.ed + sum.iced + sum.pjtd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (weapon.ps + sum.ps) * (100 + sum.wed + sum.ed + sum.iced + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (Math.floor(s.aural.hate * (100 + s.talent.aura) / 100)  + s.skill.pti + s.skill.ptiadd) / 100) * (100 - s.skill.itf) / 100),
      iceb: Math.round((sum.iceb * (100 + sum.wed + sum.ed + sum.iced + sum.pjtd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (weapon.pb + sum.pb) * (100 + sum.wed + sum.ed + sum.iced + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (Math.floor(s.aural.hate * (100 + s.talent.aura) / 100)  + s.skill.pti + s.skill.ptiadd) / 100) * (100 - s.skill.itf) / 100),
      fs: Math.round((sum.fs * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (sum.ices * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (weapon.ps + sum.ps) * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (Math.floor(s.aural.hate * (100 + s.talent.aura) / 100)  + s.skill.pti + s.skill.ptiadd) / 100) * (s.skill.itf + s.skill.itfadd) / 100 + (weapon.ps + sum.ps) * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * Math.round(s.skill.ptfadd + s.skill.ptf) / 100) * (100 - s.skill.ftz) / 100),
      fb: Math.round((sum.fb * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (sum.iceb * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (weapon.pb + sum.pb) * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (Math.floor(s.aural.hate * (100 + s.talent.aura) / 100)  + s.skill.pti + s.skill.ptiadd) / 100) * (s.skill.itf + s.skill.itfadd) / 100 + (weapon.pb + sum.pb) * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * Math.round(s.skill.ptfadd + s.skill.ptf) / 100) * (100 - s.skill.ftz) / 100),
      ts: Math.round((sum.ts * (100 + sum.wed + sum.ed + sum.td + sum.pjtd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (weapon.ps + sum.ps) * (100 + sum.wed + sum.ed + sum.td + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (s.skill.pttadd + s.skill.ptt) / 100) * (100 - s.weaponadd.ttz) / 100),
      tb: Math.round((sum.tb * (100 + sum.wed + sum.ed + sum.td + sum.pjtd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (weapon.pb + sum.pb) * (100 + sum.wed + sum.ed + sum.td + sum.pjtd + sum.pd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (s.skill.pttadd + s.skill.ptt) / 100) * (100 - s.weaponadd.ttz) / 100),
      ps: Math.round((weapon.ps + sum.ps) * (100 + sum.pjtd + sum.pd) / 100 * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (100 - s.skill.pti - s.skill.ptt - s.skill.ptf - s.skill.ptz) / 100),
      pb: Math.round((weapon.pb + sum.pb) * (100 + sum.pjtd + sum.pd) / 100 * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (100 - s.skill.pti - s.skill.ptt - s.skill.ptf - s.skill.ptz) / 100),
      zs: Math.round(sum.zs * (100 + sum.zd + sum.pjtd) / 100 * Math.round(sum.hdml * s.skill.bd) / 100 + (weapon.ps + sum.ps) * (100 + sum.pjtd + sum.pd + sum.zd) / 100 * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (s.skill.ptzadd + s.skill.ptz) / 100 + (sum.ts * (100 + sum.wed + sum.ed + sum.td + sum.pjtd +sum.zd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (weapon.ps + sum.ps) * (100 + sum.wed + sum.ed + sum.td + sum.pjtd + sum.pd + sum.zd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (s.skill.pttadd + s.skill.ptt) / 100) * s.weaponadd.ttz / 100 + (sum.fs * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd + sum.zd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (sum.ices * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd + sum.zd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (weapon.ps + sum.ps) * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd + sum.pd + sum.zd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (Math.floor(s.aural.hate * (100 + s.talent.aura) / 100)  + s.skill.pti + s.skill.ptiadd) / 100) * (s.skill.itf + s.skill.itfadd) / 100 + (weapon.ps + sum.ps) * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd + sum.pd + sum.zd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * Math.round(s.skill.ptfadd + s.skill.ptf) / 100) * s.skill.ftz / 100),
      zb: Math.round(sum.zb * (100 + sum.zd + sum.pjtd) / 100 * Math.round(sum.hdml * s.skill.bd) / 100 + (weapon.pb + sum.pb) * (100 + sum.pjtd + sum.pd + sum.zd) / 100 * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (s.skill.ptzadd + s.skill.ptz) / 100 + (sum.tb * (100 + sum.wed + sum.ed + sum.td + sum.pjtd +sum.zd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (weapon.pb + sum.pb) * (100 + sum.wed + sum.ed + sum.td + sum.pjtd + sum.pd + sum.zd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (s.skill.pttadd + s.skill.ptt) / 100) * s.weaponadd.ttz / 100 + (sum.fb * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd + sum.zd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (sum.iceb * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd + sum.zd) / 100 * sum.edml * Math.round(sum.hdml * s.skill.bd) / 100 + (weapon.pb + sum.pb) * (100 + sum.wed + sum.fd + sum.ed + sum.iced + sum.pjtd + sum.pd + sum.zd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (Math.floor(s.aural.hate * (100 + s.talent.aura) / 100)  + s.skill.pti + s.skill.ptiadd) / 100) * (s.skill.itf + s.skill.itfadd) / 100 + (weapon.pb + sum.pb) * (100 + sum.wed + sum.ed + sum.fd + sum.pjtd + sum.pd + sum.zd) / 100 * sum.edml * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * Math.round(s.skill.ptfadd + s.skill.ptf) / 100) * s.skill.ftz / 100),
      pus: ((weapon.ps + sum.ps) * (100 + sum.pjtd + sum.pd + sum.cud + sum.cupd) / 100 * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (100 - s.skill.pti - s.skill.ptt - s.skill.ptf - s.skill.ptz) / 100),
      pub: ((weapon.pb + sum.pb) * (100 + sum.pjtd + sum.pd + sum.cud + sum.cupd) / 100 * sum.pdml * Math.round(sum.hdml * s.skill.bd) / 100 * (100 - s.skill.pti - s.skill.ptt - s.skill.ptf - s.skill.ptz) / 100),
    };
    const calc = {
